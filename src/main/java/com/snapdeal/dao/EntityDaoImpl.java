...
public class EntityDaoImpl implements EntityDao{
	...
	@Override
	public <T extends BaseEntity> void delete(Class<T> objectClass,Long id) {
...
//	@Override
//	public <T extends BaseEntity> T findByPoNumber(Class<T> objectClass, Long poNumber) {
//		T object = null;
//		object = entityManager.find(objectClass, poNumber);
//		return object;
//	}
