...
pageEncoding="UTF-8"%>
<tags:page title="Update Pincode">
						...
						<div class="widget-content">
							...
							<button type="button" class="close" data-dismiss="alert">×</button>
								...
								<form class="form-box" name="file"
												action='<c:url value="/Mapping/updatePincode"/>' method="post"
							...
							<br>
							<div class="controls" align="center" style="margin-left: 20px;">
								<label for="warehouse" style="display:inline;">Warehouse: </label>
								&nbsp;<select id="warehouse" name="warehouse" style="margin-top:5px">
